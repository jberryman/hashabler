...
-- translation of test vectors from reference implementation:
...
-- output vectors, again with adjustments for endianness:
...
siphashVectorsRaw128 :: [[Word8]]
siphashVectorsRaw128 = [
